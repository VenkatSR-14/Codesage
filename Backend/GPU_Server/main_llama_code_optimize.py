...
from __main__ import llama_model_code_optimize, tokenizer_llama  # Use the preloaded model and tokenizer
import re
import torch
...
@app.post("/generate/optimize-llama")
def optimization_llama(request: InferenceRequest):
    ...
    try:
        ...
        response = generate_response(
            model=llama_model_code_optimize,
